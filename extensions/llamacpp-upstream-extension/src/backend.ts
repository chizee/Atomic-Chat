...
const BUNDLED_MANIFEST_BASELINE = {
  tag_name: 'b9881',
  assets: [
    { name: 'llama-b9881-bin-win-cpu-x64.zip' },
    { name: 'llama-b9881-bin-win-cuda-12.4-x64.zip' },
    { name: 'llama-b9881-bin-win-cuda-13.3-x64.zip' },
    { name: 'llama-b9881-bin-win-vulkan-x64.zip' },
    { name: 'llama-b9881-bin-ubuntu-x64.tar.gz' },
    { name: 'llama-b9881-bin-ubuntu-vulkan-x64.tar.gz' },
